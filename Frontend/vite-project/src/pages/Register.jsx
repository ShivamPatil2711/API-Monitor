        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-gray-200 bg-white p-8 shadow-2xl">
            ...
            <p className="mt-2 text-gray-600">
              Start watching endpoints in seconds.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3.5 bg-white border border-gray-300 rounded-2xl focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all"
                  required
                />
              </div>
